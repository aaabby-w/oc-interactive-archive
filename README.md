# 未命名档案 / UNTITLED ARCHIVE

原创角色与世界观互动档案网站。当前版本包含全屏美术图主页、浅色/深色主题切换、滚动驱动动画、视差滚动和鼠标跟随效果。
...
推送到 `main` 后，GitHub Actions 会运行 `pnpm run build:pages`，生成静态导出并发布到 GitHub Pages。
